[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/CeoFred/paystack-go) [![Build Status](https://travis-ci.org/CeoFred/paystack-go.svg?branch=master)](https://travis-ci.org/CeoFred/paystack-go) 
...
``` go
import "github.com/CeoFred/paystack-go"
